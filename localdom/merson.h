...
using namespace std;
   ...
   extern "C" {
      void solveMersonkf_(double *,double,double,double,int,int,double *,double *);
      void solveMerson_eepf_(double *,double,double,double,int,int,double *,double *);
...
class merson
{
   ...
   void solveMersonk(valarray<double>*,double,double,double,int,int);
   void solveMerson_eep(valarray<double>*,double,double,double,int,int);
   void solveMerson_sch(valarray<double>*,double,double,double,int,int);
   double acc;
   double step_min;
   double step0;
   int jtest;
   ...
   virtual valarray<double> diffeep (double, valarray<double>)=0; /* using schwandt pot */
   virtual valarray<double> diffsch (double, valarray<double>)=0; /* using schwandt pot */
