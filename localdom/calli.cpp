...
complejo Non_local_wavefunction(distorted_wave* funcion,std::complex<double>** function,vector<double> r1,vector<double> r2,potencial_optico *v, double q1q2, double masa,double radio_max,
...
{       
	...
	funcion->radio=radio_max;
        ...
        non_local_wavefunction_matrix(function,r1,r2,masa,funcion->energia,50,radio_match,funcion->l,funcion->j,q1q2,0,delta_r,radio_max,cc);
