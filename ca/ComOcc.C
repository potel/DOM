...
pad2->Draw();
 ...
 pad1->cd();
  ...
  TH2S frame("frame","",10,-55,20,10,0,1);
  ...
  g40hole.SetMarkerStyle(20);
  g40hole.SetMarkerColor(3);
  g40hole.SetLineColor(3);
  g40hole.Draw("PL");

  TGraph g40part(n40part,x40part,y40part);
  g40part.SetMarkerStyle(20);
  g40part.SetMarkerColor(3);
  g40part.SetLineColor(3);
  g40part.Draw("PL");
 ...
 pad2->cd();
  ...
  TH2S frame2("frame2","",10,-60,15,10,0,1);
  ...
  gg40hole.SetMarkerStyle(20);
  gg40hole.SetMarkerColor(3);
  gg40hole.SetLineColor(3);
  gg40hole.Draw("PL");

  TGraph gg40part(nn40part,xx40part,yy40part);
  gg40part.SetMarkerStyle(20);
  gg40part.SetMarkerColor(3);
  gg40part.SetLineColor(3);
  gg40part.Draw("PL");
